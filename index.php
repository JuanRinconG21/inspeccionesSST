...
<html lang="en" data-bs-theme="auto">
  ...
  <?php
    ...
    >
      <button
        class="btn py-2 dropdown-toggle d-flex align-items-center"
        id="bd-theme"
        type="button"
        aria-expanded="false"
      ...
      <a
        href="./inspecciones.html"
        class="btn mt-3 py-2 d-flex align-items-center"
        id="bd-theme"
        type="button"
      >
        <i
      ...
      <main>
        <div class="py-5 text-center">
          <img
            ...
            src="./assets/img/logo-bellavista.png"
            alt=""
            width="250"
            height="250"
          />
